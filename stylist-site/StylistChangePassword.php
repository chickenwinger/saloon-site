...
<head>
    ...
    <link rel="stylesheet" href="stylist-site/StylistNavbar.css">
    <style>
...
<body style="margin: 0;padding:0;background: linear-gradient(to top right, #33ccff 0%, #ff99cc 100%) fixed no-repeat;height:43.3vw;top:0%;overflow:hidden;">
<?php session_start(); ?>
    <div>
        <center>
            <div class="cpass">
                ...
                <form method="post" action="StylistChangePassword.php" name="cp" onsubmit="return matchpass()">
                    <div class="passcontent">
                        <input class="pass" id="password" name="password" type="password" placeholder="Type Your New Password" required />
    ...
    <?php if (isset($_POST['confirm'])) {
        ...
        $changepass = "UPDATE employee_list SET empPassword = '" . md5($_POST['confirm_password']) . "' WHERE empID = '".$_SESSION['empID']."'";
...
<script>
        function bckbtn() {
            location.replace("StylistProfile.php")
        }
    </script>
